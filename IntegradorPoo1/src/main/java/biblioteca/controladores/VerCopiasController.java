...
public class VerCopiasController {
    ...
    public void initialize() {
        ...
        colTipo.setCellValueFactory(cellData -> new javafx.beans.property.SimpleStringProperty(cellData.getValue().getTipo().toString()));
        ...
        colRack.setCellValueFactory(cellData -> new javafx.beans.property.SimpleStringProperty(cellData.getValue().getRack().getDescripcion()));

        // Cargar libros en combo
...
private void agregarCopia() {
    ...
    try {
        ...
        // Actualizar tabla después de agregar
        cargarCopias();
